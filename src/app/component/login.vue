  ...
  <div class="wrapper fadeInDown">
    <div id="formContent">
      ...
      <form @submit.prevent="checkLogin">
        <input type="text" v-model="user.username" id="login" class="fadeIn second" name="login" placeholder="login">
        <input type="password" v-model="user.password" id="password" class="fadeIn third" name="login"
